        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group mb-3">
              ...
              <input type="text" name="sirket" class="form-control" placeholder="Örn: <?= htmlspecialchars($_SESSION['user_name'] ?? 'ABC Teknoloji A.Ş.') ?>" value="<?= htmlspecialchars($_POST['sirket'] ?? $_SESSION['user_name'] ?? '') ?>">
            </div>
          </div>
          <div class="col-md-6">
            <div class="form-group mb-3">

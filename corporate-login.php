...
<head>
    ...
    <title>Kurumsal Giriş - ASEC</title>
...
<body>
    ...
    <main class="auth-page">
        <div class="auth-container">
            ...
            <p>Hesabınız yok mu? <a href="corporate-register.php">Kayıt Ol</a></p>
            <p style="margin-top: 10px; font-size: 0.9rem; color: #666;">Bireysel kullanıcı mısınız? <a href="login.php" style="color: #9370db; font-weight: 600;">Bireysel Giriş</a></p>
        </div>
    </main>

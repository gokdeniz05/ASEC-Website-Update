            ...
            <div id="individual-form" class="auth-form-container <?php echo $activeTab === 'individual' ? 'active' : ''; ?>">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" required value="<?php echo htmlspecialchars($activeTab === 'individual' ? ($_POST['email'] ?? '') : ''); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="g-recaptcha" id="recaptcha-individual" data-sitekey="6LeLMC8rAAAAAChTj8rlQ_zyjedV3VdnejoNAZy1"></div>
                    </div>
            ...
            <div id="corporate-form" class="auth-form-container <?php echo $activeTab === 'corporate' ? 'active' : ''; ?>">
                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="corporate_email" name="email" required value="<?php echo htmlspecialchars($activeTab === 'corporate' ? ($_POST['email'] ?? '') : ''); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="g-recaptcha" id="recaptcha-corporate" data-sitekey="6LeLMC8rAAAAAChTj8rlQ_zyjedV3VdnejoNAZy1"></div>
                    </div>
                    <input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>">
                    <button type="submit" class="cta-button"><?php echo __t('login.submit'); ?></button>
                </form>

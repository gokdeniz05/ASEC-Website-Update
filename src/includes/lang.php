...
if (!defined('IN_ADMIN')) {
    ...
    $translations = [
        'tr' => [
            ...
            'register.tab.individual' => 'Bireysel Kayıt',
            'register.tab.corporate' => 'Kurumsal Kayıt',
        ...
        'en' => [
            ...
            'register.tab.individual' => 'Individual Registration',
            'register.tab.corporate' => 'Corporate Registration',
            ...
            'register.corporate.success' => 'Your registration request has been created! Your account will be activated after admin approval.',
            // Profile
